# Nintendo - SNES / Famicom (bsnes 2014 Performance)

## Background

This page is about bsnes 2014 Performance, the bsnes v094 core whose file is named `bsnes2014_performance_libretro`. The current bsnes is a separate core, documented on the [bsnes](bsnes.md) page.
...
The bsnes 2014 Performance core has been authored by

- byuu

The bsnes 2014 Performance core is licensed under
...
Content that can be loaded by the bsnes 2014 Performance core have the following file extensions:
...
RetroArch database(s) that are associated with the bsnes 2014 Performance core:
...
!!! attention
	The bsnes 2014 Performance core uses split ROMS for [special chip games](https://en.wikipedia.org/wiki/List_of_Super_NES_enhancement_chips#List_of_Super_NES_games_that_use_enhancement_chips).
...
Frontend-level settings or features that the bsnes 2014 Performance core respects.
...
The bsnes 2014 Performance core's internal core name is 'bsnes'

The bsnes 2014 Performance core saves/loads to/from these directories.
...
- The bsnes 2014 Performance core's core provided FPS is 60.0988118623 for NTSC games and 50.0069789082 for PAL games.
- The bsnes 2014 Performance core's core provided sample rate is 32040.5 Hz
- The bsnes 2014 Performance core's core provided aspect ratio is 4/3
...
The bsnes 2014 Performance core supports the following device type(s) in the controls menu, bolded device types are the default for the specified user(s):
...
- [Libretro bsnes 2014 Performance Core info file](https://github.com/libretro/libretro-core-info/blob/master/bsnes2014_performance_libretro.info)
- [Libretro bsnes 2014 Performance Github Repository](https://github.com/libretro/bsnes-libretro)
- [Report Libretro bsnes 2014 Performance Core Issues Here](https://github.com/libretro/bsnes-libretro/issues)
