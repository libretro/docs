...
The FB Alpha 2012 CPS-1 core has been authored by

- Team FB Alpha

The FB Alpha 2012 CPS-1 core is licensed under
...
Content that can be loaded by the FB Alpha 2012 CPS-1 core have the following file extensions:

- .zip

## Features

Frontend-level settings or features that the FB Alpha 2012 CPS-1 core respects.
...
The FB Alpha 2012 CPS-1 core's library name is 'FB Alpha 2012 CPS-1'

## Core options

The FB Alpha 2012 CPS-1 core has the following option(s) that can be tweaked from the core options menu. The default setting is bolded.

- **CPU Speed (%)** [fba2012cps1_cpu_speed_adjust] (**100**|110|120|130|140|150|160|170|180|190|200)

	Enables overclocking of the emulated CPU. Can reduce slowdown, but may cause glitches.

- **High scores** [fba2012cps1_hiscores] (enabled|**disabled**)
...
- **Core-Provided Aspect Ratio** [fba2012cps1_aspect] (**DAR**|PAR)
...
- **Rotate Vertically Aligned Games (Restart)** [fba2012cps1_auto_rotate] (**enabled**|disabled)
...
- **Audio Filter** [fba2012cps1_lowpass_filter] (**disabled**|enabled)

	Enables a low pass audio filter to soften the 'harsh' sound of some arcade games.

- **Audio Filter Level (%)** [fba2012cps1_lowpass_range] (5 to 95 in steps of 5, **60**)
...
- **Frameskip** [fba2012cps1_frameskip] (**disabled**|Auto|Manual)
...
- **Frameskip Threshold (%)** [fba2012cps1_frameskip_threshold] (15 to 60 in steps of 3, **33**)

	When 'Frameskip' is set to 'Manual', specifies the audio buffer occupancy threshold (percentage) below which frames will be skipped. Higher values reduce the risk of crackling by causing frames to be dropped more frequently.

- **Diagnostic Input** [fba2012cps1_diagnostics] (**disabled**|enabled)

	Toggle ON then resume content to open service menu.

## External Links

- [FB Alpha 2012 CPS-1 Repository](https://github.com/libretro/fbalpha2012_cps1)
- [Report FB Alpha 2012 CPS-1 Core Issues Here](https://github.com/libretro/fbalpha2012_cps1/issues)
