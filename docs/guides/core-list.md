...
| a5200                     | Atari 5200             |                    |
| [Amiberry](../library/amiberry.md) | Commodore Amiga        | Amiberry is a lightweight, optimized Amiga emulator based on UAE |
| Anarch                    | Game                   | A port of Anarch, 90s-style Doom clone shooter game |
| [AppleWin](../library/applewin.md) | Apple II               | Apple II - AppleWin emulator |
| [Ardens](../library/ardens.md) | Arduboy                | A simulator for the Arduboy FX |
| [Arduous](../library/arduous.md) | Arduboy                | A emulator for Arduboy, a handheld game console with open source software, based on the Arduino hardware platform |
| [ARMSX2](../library/armsx2.md) | Sony PlayStation 2     | A libretro port of ARMSX2, a PlayStation 2 emulator forked from PCSX2 and aimed at ARM64 platforms |
| [Atari800](https://docs.libretro.com/library/atari800/) | Atari 5200             |                    |
| [b2](../library/b2.md)    | Acorn BBC Micro        |                    |
| [BBKEmu](../library/bbkemu.md) | BBK electronic dictionaries | BBKEmu is an emulator for BBK electronic dictionary game platform |
...
| [Beetle PCE](../library/mednafen_pce.md) | NEC PC Engine/SuperGrafx/CD |               |
...
| [Beetle Supafaust](../library/mednafen_supafaust.md) | Nintendo SNES/SFC      |                    |
...
| [bsnes-hd beta](../library/bsnes_hd_beta.md) | Nintendo SNES/SFC      |                    |
...
| DirectXbox                | Xbox                   |                    |
| [DirkSimple](../library/dirksimple.md) | Laserdisc arcade games | A player of laserdisc arcade games |
...
| [Emir](../library/ymir.md) | Sega Saturn            | A port of the Ymir Sega Saturn emulator to libretro |
| Emux CHIP-8               | CHIP-8                 |                    |
...
| [FB Alpha 2012](../library/fbalpha2012.md) | Arcade/Console/various | (See FB Neo note)  |
| [FB Alpha 2012 CPS-1](../library/fbalpha2012_cps1.md) | CPS-1                  |                    |
| [FB Alpha 2012 CPS-2](../library/fbalpha2012_cps2.md) | CPS-2                  |                    |
| [FB Alpha 2012 CPS-3](../library/fbalpha2012_cps3.md) | CPS-3                  |                    |
| [FB Alpha 2012 Neo Geo](../library/fbalpha2012_neogeo.md) | Neo Geo                |                    |
...
| [fixGB](../library/fixgb.md) | Game Boy/Color         |                    |
| [fixNES](../library/fixnes.md) | Nintendo NES/Famicom   |                    |
| Flycast                   | Sega Dreamcast/NAOMI   |                    |
| Flycast GLES2             | Sega Dreamcast/NAOMI   |                    |
| fMSX                      | MSX/MSX2/MSX2+         |                    |
| [FreeChaF](../library/freechaf.md) | Fairchild ChannelF     |                    |
| [FreeIntv](../library/freeintv.md) | Mattel Intellivision   |                    |
| FreeJ2ME                  | J2ME                   | a port of Java 2 Micro Edition emulator |
| [Frodo](../library/frodo.md) | Commodore C64          |                    |
| [FS-UAE](../library/fsuae.md) | Commodore Amiga        |                    |
| Fuse                      | Sinclair ZX Spectrum   |                    |
| [Galaksija](../library/galaksija.md) | Galaksija              | Galaksija (Galaxy) was a low-cost home computer released in 1983 in the former Yugoslav countries as a build-it-yourself kit |
...
| [Gong](../library/gong.md) | Game                   | A clone of Pong written for libretro |
...
| [MAME 2000](../library/mame2000.md) | Arcade/Console/various | (See MAME note)    |
...
| [MAME 2015](../library/mame2015.md) | Arcade/Console/various | (See MAME note)    |
| MAME 2016                 | Arcade/Console/various | (See MAME note)    |
| [McSoftServe](../library/mcsoftserve.md) | Game                   | An experimental libretro core for the Taylor C713 soft-serve ice cream machine, popularized by a well-known American fast food chain |
...
| [MesenCE](../library/mesen2.md) | Multi-system           | A port of MesenCE to the libretro API |
...
| [MojoZork](../library/mojozork.md) | Infocom Z-Machine      | A Z-Machine emulator for playing text-based interactive fiction |
...
| [Neko Project II](../library/nekop2.md) | NEC PC-98              |                    |
| Neko Project II Kai       | NEC PC-98              |                    |
| [NeoCD](../library/neocd.md) | Neo Geo CD             |                    |
| [Nestopia](../library/nestopia.md)             | Nintendo NES/Famicom   |                    |
| [NooDS](../library/noods.md) | Nintendo DS            | Unofficial libretro port of NooDS, the speedy DS emulator |
| [nSide Balanced](../library/nside_balanced.md) | Nintendo SNES/SFC/Game Boy/Color |          |
| [Nuance](../library/nuance.md) | VM Labs NUON           | Nuance is a NUON (VM Labs) emulator |
...
| [Oberon](../library/oberon.md) | Oberon RISC machine    | An emulator for the Oberon RISC machine, ported to libretro |
| [Omicron](../library/omicron.md) | Game engine            | Omicron is an open source game engine for Java built on libGDX and inspired by fantasy consoles: a small API for drawing, sound and input, with no resource... |
...
| [Panda3DS](../library/panda3ds.md) | Nintendo 3DS           | Panda3DS is an HLE, red-panda-themed Nintendo 3DS emulator |
| [ParaLLEl N64](../library/parallel_n64.md) | Nintendo 64            |                    |
| PascalPong                | Game                   | A free and basic clone of the classic Pong game, written for libretro |
| [PCem](../library/pcem.md) | IBM PC                 |                    |
...
| [pokketstation](../library/pokketstation.md) | Sony PocketStation     | An open-source Sony PocketStation emulator core, written in portable C |
| [Potator](../library/potator.md) | Watara Supervision     |                    |
...
| PX68k                     | Sharp X68000           |                    |
| [QEMU](../library/qemu.md) | PC                     | A port of the QEMU emulator to libretro |
| QUASI88                   | NEC PC-8000/PC-8800 series |                |
| [QuickNES](../library/quicknes.md)   | Nintendo NES/Famicom   |                    |
| RACE                      | Neo Geo Pocket/Color   |                    |
| [Radio](../library/radio.md) | Internet radio         | Streams internet radio stations over the network, and plays local MP3 and WAV files |
...
| [RemoteJoy](../library/remotejoy.md) | PSP remote play        | An old, experimental libretro core designed to stream inputs to/from a Playstation Portable console |
| [Retro8](../library/retro8.md) | Game engine            | A port of the Retro8 open-source reimplementation of the PICO-8 fantasy console to libretro |
| [ROM Cleaner](../library/romcleaner.md) | -                      | A utility core for removing dust and dirt from your ROM collection |
...
| SimCoupe                  | SAM Coupe              |                    |
| [SkyEmu](../library/skyemu.md) | Nintendo GB/GBC/GBA/DS | SkyEmu is a multi-system emulator, supporting Game Boy, Game Boy Color and Nintendo DS cores |
...
| [SquirrelJME](../library/squirreljme.md) | Java ME                | A port of the SquirrelJME Java ME 8 Virtual Machine emulator to libretro |
| [Stella](https://docs.libretro.com/library/stella/)                     | Atari 2600             |                    |
| Stella 2014               | Atari 2600             |                    |
| [Super Bros War](../library/superbroswar.md) | Game engine            | A fork of Super Mario War, a fan-made multiplayer Super Mario Bros. style deathmatch game |
...
| [TamaLIBretro](../library/tamalibretro.md) | Bandai Tamagotchi P1   | A port of the TamaLIB emulator for first-generation Tamagotchi handhelds to libretro |
...
| [vitaQuake 2](../library/vitaquake2.md) | Game engine            | A port of the VitaQuake 2 source port of iD's Quake 2 engine to libretro. There is a separate core for each of the Quake 2 mission packs, 'Rogue', 'Zaero' and 'Xatrix'. |
...
| [vitaQuake 3](../library/vitaquake3.md) | Game engine            | A port of the VitaQuake 3 source port of iD's ioquake3 engine to libretro |
...
| [X Millennium](../library/x1.md) | Sharp X1               |                    |
