# XMB Menu Map
Note: entries followed by an ellipsis (**...**) will bring up the file browser to select an external file. Entries in **bold** are submenus
## Tabs
### Main Menu
  ...
  - **Online Updater**
    ...
    + **Content Downloader**
      - (Varies by what is on the remote server)
